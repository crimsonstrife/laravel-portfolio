    ...
    function minMaxTimePlugin(config) {
        ...
        function findDateTimeLimit(date) {
            if (config.table !== undefined) {
                return config.table[
                    state.formatDate(date, state.tableDateFormat)
                ];
            }
            ...
            return {
                ...
                onChange: function () {
                    ...
                    if (latest && matchingTimeLimit !== undefined) {
                        ...
                        if (
                            compareDates(latest, fp.config.maxTime, false) > 0
                        ) {
                            fp.setDate(
                            ...
                            compareDates(latest, fp.config.minTime, false) < 0
                        )
                            fp.setDate(
                                new Date(latest.getTime()).setHours(
