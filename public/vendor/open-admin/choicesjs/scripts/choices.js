    ...
    return /******/ (function (modules) {
        ...
        /******/ [
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                exports.generateId = function (element, prefix) {
                    var id =
                        element.id ||
                        (element.name &&
                            element.name + "-" + exports.generateChars(2)) ||
                ...
                exports.getAdjacentEl = function (
                    startEl,
                    selector,
                    direction
                ) {
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                /* harmony import */ var symbol_observable__WEBPACK_IMPORTED_MODULE_0__ =
                ...
                var WrappedElement =
                    ...
                    (function () {
                        ...
                        WrappedElement.prototype.reveal = function () {
                            ...
                            // Remove duplicate expression on both sides of the assignment
                            // deepcode ignore CopyPasteError: <TODO>
                ...
                var Choices =
                    ...
                    (function () {
                        function Choices(element, userConfig) {
                            ...
                            var invalidConfigOptions = utils_1.diff(
                                this.config,
                                constants_1.DEFAULT_CONFIG
                            );
                            ...
                            this._baseId = utils_1.generateId(
                            ...
                            if (this.passedElement.options) {
                                this.passedElement.options.forEach(function (
                                    ...
                                    _this._presetChoices.push({
                                        ...
                                        customProperties:
                                            option.dataset["custom-properties"],
                                    });
                                });
                            }
                        ...
                        Choices.prototype.unhighlightItem = function (item) {
                            ...
                            this._store.dispatch(
                                items_1.highlightItem(id, false)
                            );
                        ...
                        Choices.prototype.clearInput = function () {
                            ...
                            if (!this._isTextElement && this._canSearch) {
                                ...
                                this._store.dispatch(
                                    choices_1.activateChoices(true)
                                );
                            }
                        ...
                        Choices.prototype._createItemsFragment = function (
                            ...
                            var addItemToFragment = function addItemToFragment(
                                item
                            ) {
                        ...
                        Choices.prototype._canAddItem = function (
                            ...
                            if (!this._isSelectOneElement) {
                                var isDuplicateValue = utils_1.existsInArray(
                                    activeItems,
                                    value
                                );
                        ...
                        Choices.prototype._searchChoices = function (value) {
                            ...
                            this._store.dispatch(
                                choices_1.filterChoices(results)
                            );
                        ...
                        Choices.prototype._onKeyDown = function (event) {
                            ...
                            var wasAlphaNumericChar = /[a-zA-Z0-9-_ ]/.test(
                                keyString
                            );
        ...
        */
                        ...
                        Choices.prototype._onDirectionKey = function (
                            ...
                            var downKey = constants_1.KEY_CODES.DOWN_KEY,
                                ...
                                pageDownKey =
                                    constants_1.KEY_CODES.PAGE_DOWN_KEY; // If up or down key is pressed, traverse through options
                        ...
                        Choices.prototype._onBlur = function (_a) {
                            ...
                            if (
                                ...
                                var blurActions =
                                    ...
                                    (_b[constants_1.SELECT_ONE_TYPE] =
                                        function () {
                                            _this.containerOuter.removeFocusState();
                        ...
                        Choices.prototype._onFormReset = function () {
                            this._store.dispatch(
                                misc_1.resetTo(this._initialState)
                            );
                        };
                        ...
                        Choices.prototype._removeItem = function (item) {
                            ...
                            this._store.dispatch(
                                items_1.removeItem(id, choiceId)
                            );
                        ...
                        Choices.prototype._addGroup = function (_a) {
                            ...
                            var groupChoices = utils_1.isType("Object", group)
                                ? group.choices
                                : Array.from(
                            ...
                            if (groupChoices) {
                                ...
                                var addGroupChoices = function addGroupChoices(
                                    ...
                                    _this._addChoice({
                                        ...
                                        label: utils_1.isType("Object", choice)
                                            ? choice[labelKey]
                                            : choice.innerHTML,
                                        isSelected: choice.selected,
                        ...
                        Choices.prototype._getTemplate = function (template) {
                            ...
                            return (_a = this._templates[template]).call.apply(
                                _a,
                                __spreadArrays([this, classNames], args)
                            );
                        };
                        ...
                        Choices.prototype._createTemplates = function () {
                            ...
                            this._templates = deepmerge_1.default(
                                templates_1.default,
                                userTemplates
                            );
                        };
                        ...
                        Choices.prototype._addPredefinedGroups = function (
                            groups
                        ) {
                        ...
                        Choices.prototype._addPredefinedItems = function (
                            items
                        ) {
                            var _this = this;
                        ...
                        Choices.prototype._findAndSelectChoiceByValue =
                            function (value) {
                                var _this = this;
                        ...
                        Choices.prototype._generatePlaceholderValue =
                            function () {
                                if (this._isSelectElement) {
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var Store =
                    ...
                    (function () {
                        function Store() {
                            this._store = redux_1.createStore(
                                index_1.default,
                        ...
                        Object.defineProperty(
                            ...
                            "placeholderChoice",
                            {
                                 ...
                                 */
                                get: function get() {
                                    return __spreadArrays(this.choices)
                                        .reverse()
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var Container =
                    ...
                    (function () {
                        ...
                        Container.prototype.shouldFlip = function (
                            dropdownPos
                        ) {
                        ...
                        Container.prototype.removeActiveDescendant =
                            function () {
                                this.element.removeAttribute(
                                    "aria-activedescendant"
                                );
                                ...
                                set: function set(options) {
                                    ...
                                    var addOptionToFragment =
                                        function addOptionToFragment(data) {
                                            ...
                                            return option; // Add a return statement to fix the problem
                                        };
