                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    value: function addEventListener(
                                        ...
                                        this.dualListbox.addEventListener(
                                            eventName,
                                            callback
                                        );
                                    },
                                },
                                {
                                    ...
                                    value: function addSelected(listItem) {
                                        var _this = this;
                                        var index =
                                            this.available.indexOf(listItem);
                                        if (index > -1) {
                                            ...
                                            setTimeout(function () {
                                                ...
                                                _this.dualListbox.dispatchEvent(
                                                    event
                                                );
                                            }, 0);
                                        }
                                ...
                                },
                                {
                                    ...
                                    value: function removeSelected(listItem) {
                                        var _this2 = this;
                                        var index =
                                            this.selected.indexOf(listItem);
                                        if (index > -1) {
                                            ...
                                            setTimeout(function () {
                                                ...
                                                _this2.dualListbox.dispatchEvent(
                                                    event
                                                );
                                            }, 0);
                                        }
                                ...
                                {
                                    key: "searchLists",
                                    value: function searchLists(
                                        searchString,
                                        dualListbox
                                    ) {
                                        var items =
                                            dualListbox.querySelectorAll(
                                                ".".concat(ITEM_ELEMENT)
                                            );
                                ...
                                },
                                {
                                    ...
                                    value: function _actionAllSelected(event) {
                                        ...
                                        var selected = this.available.filter(
                                            function (item) {
                                                return (
                                                    item.style.display !==
                                                    "none"
                                ...
                                },
                                {
                                    ...
                                    value: function _actionItemSelected(event) {
                                        event.preventDefault();
                                        var selected =
                                            this.dualListbox.querySelector(
                                ...
                                },
                                {
                                    ...
                                    value: function _actionAllDeselected(
                                        event
                                    ) {
                                        var _this4 = this;
                                        event.preventDefault();
                                        var deselected = this.selected.filter(
                                            function (item) {
                                                return (
                                                    item.style.display !==
                                                    "none"
                                        ...
                                        for (
                                            ...
                                            var item = deselected[i];
                                            removedItems.push(item);
                                            _this4.removeSelected(item);
                                        }
                                        return;
                                    },
                                },
                                {
                                    ...
                                    value: function _actionItemDeselected(
                                        event
                                    ) {
                                        event.preventDefault();
                                        var selected =
                                ...
                                },
                                {
                                    ...
                                    value: function _actionItemDoubleClick(
                                        listItem
                                    ) {
                                        var event =
                                            arguments.length > 1 &&
                                        ...
                                        if (
                                            this.selected.indexOf(listItem) > -1
                                        ) {
                                ...
                                },
                                {
                                    ...
                                    value: function _actionItemClick(
                                        listItem,
                                        dualListbox
                                    ) {
                                        var event =
                                ...
                                },
                                {
                                    ...
                                    value: function _addButtonActions() {
                                        ...
                                        this.add_all_button.addEventListener(
                                            "click",
                                            function (event) {
                                                return _this5._actionAllSelected(
                                                    event
                                                );
                                            }
                                        );
                                        this.add_button.addEventListener(
                                            "click",
                                            function (event) {
                                                return _this5._actionItemSelected(
                                                    event
                                                );
                                            }
                                        );
                                        this.remove_button.addEventListener(
                                            "click",
                                            function (event) {
                                                return _this5._actionItemDeselected(
                                                    event
                                                );
                                            }
                                        );
                                        this.remove_all_button.addEventListener(
                                            "click",
                                            function (event) {
                                                return _this5._actionAllDeselected(
                                                    event
                                                );
                                            }
                                        );
                                ...
                                },
                                {
                                    ...
                                    value: function _addClickActions(listItem) {
                                        ...
                                        listItem.addEventListener(
                                            "dblclick",
                                            function (event) {
                                                return _this6._actionItemDoubleClick(
                                                    listItem,
                                                    event
                                                );
                                            }
                                ...
                                },
                                {
                                    ...
                                    value: function _buildDualListbox(
                                        container
                                    ) {
                                ...
                                },
                                {
                                    ...
                                    value: function _createSearchLeft() {
                                        ...
                                        this.search_left.classList.add(
                                            SEARCH_ELEMENT
                                        );
                                        this.search_left.placeholder =
                                ...
                                },
                                {
                                    ...
                                    value: function _createSearchRight() {
                                        this.search_right =
                                            document.createElement("input");
                                        this.search_right.classList.add(
                                            SEARCH_ELEMENT
                                        );
                                        this.search_right.placeholder =
                                            this.searchPlaceholder;
                                    },
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    value: function _splitOptions(options) {
                                        for (
                                            ...
                                            var option = options[i];
                                            if (
                                                DualListbox.isDomElement(option)
                                            ) {
                                                this._addOption({
